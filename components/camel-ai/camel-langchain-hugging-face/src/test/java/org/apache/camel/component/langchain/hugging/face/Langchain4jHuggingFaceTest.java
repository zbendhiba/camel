...
public class Langchain4jHuggingFaceTest extends CamelTestSupport {
    ...
    protected void setupResources() throws Exception {
        ...
        // TODO temporary ?
        var hfApiKey = System.getenv("HF_API_KEY");
        ...
        return new RouteBuilder() {
            public void configure() {
                from("direct:send-simple-message")
                        .to("langchain-hugging-face:chat-simple?chatModel=#huggingFaceChatModel&chatOperation=CHAT_SINGLE_MESSAGE")
                        .to("mock:response");

                from("direct:send-message-prompt")
                        .to("langchain-hugging-face:chat-prompt?chatModel=#huggingFaceChatModel&chatOperation=CHAT_SINGLE_MESSAGE_WITH_PROMPT")
                        .to("mock:response");
            };
        };
    }
