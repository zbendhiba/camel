        ...
        return new RouteBuilder() {
            public void configure() {
                from("direct:send-simple-message")
                        .to("langchain-openai://chat?chatModel=#openAiChatModel&chatOperation=CHAT_SINGLE_MESSAGE")
                        .to("mock:response");

                from("direct:send-message-prompt")
                        .to("langchain-openai://chat?chatModel=#openAiChatModel&chatOperation=CHAT_SINGLE_MESSAGE_WITH_PROMPT")
                        .to("mock:response");
            };
        };
    }
