...
public class LangChain4jAgentServiceIT extends AbstractRAGTest {
    ...
    void testCompleteIntegrationWithoutMemory() throws InterruptedException {
        ...
        // Single interaction without memory - combines Tools + RAG + Guardrails (NO MEMORY)
    ...
    protected RouteBuilder createRouteBuilder() {
        ...
        return new RouteBuilder() {
            public void configure() {
                ...
                // Complete integration WITHOUT MEMORY: Tools + RAG + Guardrails (no chatMemoryProvider)
